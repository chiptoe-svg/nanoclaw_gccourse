...
interface LegacyContainerJson {
  ...
  /** Classroom-only — per-group env vars for code we don't own (e.g. GOOGLE_APPLICATION_CREDENTIALS). */
  env?: Record<string, string>;
  /** Classroom-only — per-group model allowlist (driven by playground Models tab). */
