...
export const PLAYGROUND_ENABLED = (process.env.PLAYGROUND_ENABLED || '').toLowerCase() === '1' || (process.env.PLAYGROUND_ENABLED || '').toLowerCase() === 'true';
...
export const PLAYGROUND_BIND_HOST: string = process.env.PLAYGROUND_BIND_HOST || playgroundEnv.PLAYGROUND_BIND_HOST || '0.0.0.0';
